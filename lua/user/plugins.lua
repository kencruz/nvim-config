...
return lazy.setup({
  spec = {
    -- My plugins here
    { "wbthomason/packer.nvim", commit = "ea0cc3c59f67c440c5ff0bbe4fb9420f4350b9a3" }, -- Have packer manage itself
    ...
    -- { "numToStr/Comment.nvim", commit = "2c26a00f32b190390b664e56e32fd5347613b9e2" } -- the latest requires 0.8
    ...
    -- { "kyazdani42/nvim-web-devicons", commit = "8d2c5337f0a2d0a17de8e751876eeb192b32310e" } -- the latest requires >= 0.7.0
    { "nvim-tree/nvim-tree.lua", commit = "e9c5abe073a973f54d3ca10bfe30f253569f4405" }, -- the latest requires >=0.8.0
    -- { "kyazdani42/nvim-tree.lua", commit = "bdb6d4a25410da35bbf7ce0dbdaa8d60432bc243" } -- the latest requires >=0.8.0
    { "akinsho/bufferline.nvim", commit = "99337f63f0a3c3ab9519f3d1da7618ca4f91cffe" }, -- the latest requires >=0.8
    -- { "akinsho/bufferline.nvim", commit = "e48ce1805697e4bb97bc171c081e849a65859244" } -- the latest requires >=0.8
    -- { "akinsho/bufferline.nvim", commit = "c78b3ecf9539a719828bca82fc7ddb9b3ba0c353" } -- the latest requires >=0.8
    ...
    -- { "nvim-lualine/lualine.nvim", commit = "3362b28f917acc37538b1047f187ff1b5645ecdd" } -- the latest requires >= 0.7
    { "akinsho/toggleterm.nvim", commit = "e3805fed94d487b81e9c21548535cc820f62f840" }, -- the latest requires >= 0.7
    -- { "akinsho/toggleterm.nvim", commit = "aaeed9e02167c5e8f00f25156895a6fd95403af8" } -- the latest requires >= 0.7
    { "ahmedkhalf/project.nvim", commit = "8c6bad7d22eef1b71144b401c9f74ed01526a4fb" }, -- the latest requires >= 0.5.0
    -- { "ahmedkhalf/project.nvim", commit = "541115e762764bc44d7d3bf501b6e367842d3d4f" } -- the latest requires >= 0.5.0
    -- { "lewis6991/impatient.nvim", commit = "969f2c5c90457612c09cf2a13fee1adaa986d350" } -- the latest requires >= 0.7, no longer needed in 0.9 see readme
    ...
    --[[ { "luisiacc/gruvbox-baby", commit = "4f1df4ed179705179ebb4e57b6ac4dedc4130d7e" } ]]
    ...
    -- { "L3MON4D3/LuaSnip", commit = "79b2019c68a2ff5ae4d732d50746c901dd45603a" } --snippet engine, requires >= 0.7
    ...
    --[[ { "williamboman/nvim-lsp-installer", commit = "17e0bfa5f2c8854d1636fcd036dc8284db136baa" } -- simple to use language server installer, latest requires >=0.7, no longer maintained -> replace with mason.nvim ]]
    -- { "williamboman/nvim-lsp-installer", commit = "e9f13d7acaa60aff91c58b923002228668c8c9e6" } -- simple to use language server installer, latest requires >=0.7, no longer maintained -> replace with mason.nvim
    ...
    -- { "RRethy/vim-illuminate", commit = "c82e6d04f27a41d7fdcad9be0bce5bb59fcb78e5" }
    ...
    -- { "simrat39/rust-tools.nvim", commit = "b297167d9e01accc9b9afe872ce91e791df2dde0" } -- rust tools, no longer maintained -> replace with mrcjkb/rustaceanvim
    {
    ...
    -- { "nvim-treesitter/nvim-treesitter-context", commit = "d28654b012d4c56beafec630ef7143275dff76f8"} -- for sticky function signatures, the latest requires >= v0.9.0
    ...
    -- { "lewis6991/gitsigns.nvim", commit = "c18e016864c92ecf9775abea1baaa161c28082c3" } -- the latest requires >= 0.8.0
    ...
    -- { "mfussenegger/nvim-dap", commit = "014ebd53612cfd42ac8c131e6cec7c194572f21d" } -- the latest requires >= 0.9.0
